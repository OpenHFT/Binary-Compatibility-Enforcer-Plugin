...
If you are using teamcity then to enable to the report to hosted as an html by your teamcity server, then set the following
...
NOTE: If you set `artifactsURI` and you are not running on teamcity this setting will be ignored.
